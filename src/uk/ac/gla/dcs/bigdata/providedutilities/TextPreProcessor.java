...
/**
 * This class provides pre-processing for text strings based on the Terrier IR
 * platform. In particular, it provides an out-of-the-box function for
 * performing stopword removal and stemming on a text string.
 * 
 * @author Richard
 *
 */
